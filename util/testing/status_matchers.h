...
==============================================================================*/
#ifndef THIRD_PARTY_SILIFUZZ_UTIL_TESTING_STATUS_MATCHERS_H_
#define THIRD_PARTY_SILIFUZZ_UTIL_TESTING_STATUS_MATCHERS_H_
...
//               StatusIs(Ne(absl::StatusCode::kCancelled),
//                        HasSubstr("Cancelled"))));
//
// =============================
// StatusIs(status_code_matcher)
...
void PrintTo(const absl::StatusOr<T>& status_or, std::ostream* os) {
  *os << ::testing::PrintToString(status_or.status());
  if (status_or.ok()) {
    *os << ": " << ::testing::PrintToString(*status_or);
  }
}
...
#endif  // THIRD_PARTY_SILIFUZZ_UTIL_TESTING_STATUS_MATCHERS_H_
