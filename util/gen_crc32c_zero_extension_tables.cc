...
//
// To generate tables, runs:
//   bazel run third_party/silifuzz/util:gen_crc32c_zero_extension_tables |
//     clang-format > third_party/silifuzz/util/crc32c_zero_extension_tables.cc
