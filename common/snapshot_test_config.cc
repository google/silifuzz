...
const TestSnapshotConfig configs[44] = {
    {
    ...
    },
    {
        ...
        .data_num_bytes = 0x1000,
        //     12455000:   48 31 c0                xor    %rax,%rax
        //     12455003:   ff e0                   jmp    *%rax
        .instruction_bytes = {0x48, 0x31, 0xc0, 0xff, 0xe0},
        .normal_end = false,
    },
    {
    ...
    },
    {
        ...
        .data_addr = 0x123d6000,
        .data_num_bytes = 0x1000,
        //     123d5000:   d2a00020        mov     x0, #0x10000
    ...
    },
    {
        ...
        .data_addr = 0x123f6000,
        .data_num_bytes = 0x1000,
        //     123f5000:   d2a00020        mov     x0, #0x10000
    ...
    },
    {
        ...
        .data_addr = 0x12406000,
        .data_num_bytes = 0x1000,
        //     12405000:   aa1f03e0        mov     x0, xzr
        //     12405004:   aa1f03e1        mov     x1, xzr
        //     12405008:   aa1f03e2        mov     x2, xzr
        //     1240500c:   d28026a8        mov     x8, #0x135
        //     12405010:   d4000001        svc     #0x0
        //     12405014:   aa1f03e0        mov     x0, xzr
    ...
    },
    {
        ...
        .data_addr = 0x12416000,
        .data_num_bytes = 0x1000,
        //     12415000:   14000000        b       0x12415000
    ...
    },
    {
        ...
        .data_addr = 0x12426000,
        .data_num_bytes = 0x1000,
        //     12425000:   91000842        add     x2, x2, #0x2
        //     12425004:   91000c63        add     x3, x3, #0x3
        //     12425008:   91001084        add     x4, x4, #0x4
    ...
    },
    {
        ...
        .data_addr = 0x12436000,
        .data_num_bytes = 0x1000,
        //     12435000:   aa1f03e0        mov     x0, xzr
        //     12435004:   d2800bc8        mov     x8, #0x5e
        //     12435008:   d4000001        svc     #0x0
