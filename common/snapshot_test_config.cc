...
const TestSnapshotConfig configs[27] = {
    {
    ...
    },
    {
        ...
        .data_addr = 0x12366000,
        .data_num_bytes = 0x1000,
        //     12365000:   f81f83e0        stur    x0, [sp, #-8]
        //     12365004:   aa3f03e0        mvn     x0, xzr
        //     12365008:   f81c03e0        stur    x0, [sp, #-64]
        //     1236500c:   f85f83e0        ldur    x0, [sp, #-8]
    ...
    },
    {
        ...
        .data_addr = 0x12376000,
        .data_num_bytes = 0x1000,
        //     12375000:   f94000c0        ldr     x0, [x6]
        //     12375004:   f9400000        ldr     x0, [x0]
