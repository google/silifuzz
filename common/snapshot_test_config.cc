...
const TestSnapshotConfig configs[59] = {
    {
    ...
    {
        .type = TestSnapshot::kSetThreeAVXRegisters,
        .arch = ArchitectureId::kX86_64,
        .code_addr = 0x32535000,
        .code_num_bytes = 0x1000,
        .data_addr = 0x200000,
        .data_num_bytes = 0x1000,
        //     32535000:   b8 78 56 34 12          mov    $0x12345678,%eax
        //     32535005:   66 0f 6e d0             movd   %eax,%xmm2
        //     32535009:   c4 62 79 79 d2          vpbroadcastw %xmm2,%xmm10
        //     3253500e:   c4 62 7d 58 fa          vpbroadcastd %xmm2,%ymm15
        .instruction_bytes = {0xb8, 0x78, 0x56, 0x34, 0x12, 0x66, 0xf, 0x6e,
                              0xd0, 0xc4, 0x62, 0x79, 0x79, 0xd2, 0xc4, 0x62,
                              0x7d, 0x58, 0xfa},
        .normal_end = false,
    },
    {
        .type = TestSnapshot::kSetThreeAVX512Registers,
        .arch = ArchitectureId::kX86_64,
        .code_addr = 0x32545000,
        .code_num_bytes = 0x1000,
        .data_addr = 0x210000,
        .data_num_bytes = 0x1000,
        //     32545000:   b8 78 56 34 12          mov    $0x12345678,%eax
        //     32545005:   62 f2 7d 28 7c d0       vpbroadcastd %eax,%ymm2
        //     3254500b:   62 e2 fd 48 7c e0       vpbroadcastq %rax,%zmm20
        //     32545011:   c5 f8 92 e0             kmovw  %eax,%k4
        .instruction_bytes = {0xb8, 0x78, 0x56, 0x34, 0x12, 0x62, 0xf2,
                              0x7d, 0x28, 0x7c, 0xd0, 0x62, 0xe2, 0xfd,
                              0x48, 0x7c, 0xe0, 0xc5, 0xf8, 0x92, 0xe0},
        .normal_end = false,
    },
    {
    ...
    {
        .type = TestSnapshot::kSetThreeSVERegisters,
        .arch = ArchitectureId::kAArch64,
        .code_addr = 0x324a5000,
        .code_num_bytes = 0x1000,
        .data_addr = 0x700160000,
        .data_num_bytes = 0x1000,
        //     324a5000:   2559e3e3        ptrues  p3.h
        //     324a5004:   05c38183        mov     z3.d, #0x1fff0000
        //     324a5008:   252c9000        setffr
        .instruction_bytes = {0xe3, 0xe3, 0x59, 0x25, 0x83, 0x81, 0xc3, 0x5,
                              0x0, 0x90, 0x2c, 0x25},
        .normal_end = true,
    },
    {
        .type = TestSnapshot::kIndirectBranch,
        .arch = ArchitectureId::kAArch64,
        .code_addr = 0x324b5000,
        .code_num_bytes = 0x1000,
        .data_addr = 0x700170000,
        .data_num_bytes = 0x1000,
        //     324b5000:   94000001        bl      0x324b5004
        //     324b5004:   910023c0        add     x0, x30, #0x8
        //     324b5008:   d61f0000        br      x0
        //     324b500c:   d503201f        nop
        .instruction_bytes = {0x1, 0x0, 0x0, 0x94, 0xc0, 0x23, 0x0, 0x91, 0x0,
                              0x0, 0x1f, 0xd6, 0x1f, 0x20, 0x3, 0xd5},
        .normal_end = true,
    },
    {
        .type = TestSnapshot::kFpAndAdvancedSIMD,
        .arch = ArchitectureId::kAArch64,
        .code_addr = 0x324c5000,
        .code_num_bytes = 0x1000,
        .data_addr = 0x700180000,
        .data_num_bytes = 0x1000,
        //     324c5000:   1e2e1007        fmov    s7, #1.000000000000000000e+00
        .instruction_bytes = {0x7, 0x10, 0x2e, 0x1e},
        .normal_end = true,
    },
};
