...
bool OperandIsGPRegister(const xed_operand_t* operand) {
  ...
  switch (name) {
    ...
    case XED_NONTERMINAL_VGPR16_N3:
    case XED_NONTERMINAL_VGPR16_N3_64:
    ...
    case XED_NONTERMINAL_VGPR32_N3:
    case XED_NONTERMINAL_VGPR32_N3_64:
    ...
    case XED_NONTERMINAL_VGPR64_N3:
    case XED_NONTERMINAL_VGPR64_N3_64:
    case XED_NONTERMINAL_VGPR64_N3_NORSP:
    case XED_NONTERMINAL_VGPR64_R:
    case XED_NONTERMINAL_VGPR8_N3:
    case XED_NONTERMINAL_VGPR8_N3_64:
    case XED_NONTERMINAL_VGPRV_N3:
