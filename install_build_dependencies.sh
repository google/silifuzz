...
apt install --no-install-recommends -y git bazel-6.4.0 libssl-dev clang libclang-rt-dev lld python3 libpython3-stdlib
ln -s -f /usr/bin/bazel-6.4.0 /usr/bin/bazel
